...
class relu:
    ...
    def backward(self, X, grad):
        ...
        """
            ...
            - PLEASE follow the Heaviside step function defined in CSE 5523 HW5 problem set
...
class dropout:
    ...
    def backward(self, X, grad):
        ...
        """
            ...
            - Check CSE 5523 HW5 problem set for the backward pass of dropout.
...
## Please list with whome you discuss the homework with (one per line, create more lines if you need)
    ## 
    ##
    ##